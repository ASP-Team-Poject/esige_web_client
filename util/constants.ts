...
export const userRoles = {
  ...
  ROLE_NATIONAL: '["SUPERVISEUR_NATIONAL"]',
  ROLE_PROVINCE: '["SUPERVISEUR_PROVINCE"]',
  ROLE_PROVED: '["SUPERVISEUR_PROVED"]',
  ROLE_SOUSPROVED: '["SUPERVISEUR_SOUSPROVED"]',
  ROLE_ENCODEUR: '["ENCODEUR"]',
};
